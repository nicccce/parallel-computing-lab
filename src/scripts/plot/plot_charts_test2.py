...
test2.fasta. Data points are the averages of three remote run_all.ps1 runs on
...
times = [184.910, 105.410, 56.573, 30.967, 18.547, 11.587, 9.713]
...
ax.set_title("Execution Time vs. Thread Count (test2.fasta, threshold=0.85)")
ax.set_xticks(x)
...
ax.set_title("Speedup vs. Thread Count (test2.fasta)")
...
ax.set_title("Parallel Efficiency vs. Thread Count (test2.fasta)")
ax.set_xticks(x)
ax.set_xticklabels(threads)
